...
"armv8l\-linux\-thread\-multi\-64int-6\.1\.90\-0\-lts" or
	die "Errno architecture (armv8l\-linux\-thread\-multi\-64int-6\.1\.90\-0\-lts) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
