...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 769,      /* -Wpoison-system-directories */
  ...
  OPT_Wtemplate_id_cdtor = 853,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplates = 854,                      /* -Wtemplates */
  OPT_Wterminate = 855,                      /* -Wterminate */
  OPT_Wtraditional = 856,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 857,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 858,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 859,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 860,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 861,                           /* -Wtsan */
  OPT_Wtype_limits = 862,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 863,            /* -Wundeclared-selector */
  OPT_Wundef = 864,                          /* -Wundef */
  OPT_Wundefined_do_loop = 865,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 866,                      /* -Wunderflow */
  OPT_Wunicode = 867,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 868,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 869,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 870,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 871,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 872, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 873, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 874,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 875,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 876,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 877,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 878, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 879,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 880,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 881,                /* -Wunused-function */
  OPT_Wunused_label = 882,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 883,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 884,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 885,               /* -Wunused-parameter */
  OPT_Wunused_result = 886,                  /* -Wunused-result */
  OPT_Wunused_value = 887,                   /* -Wunused-value */
  OPT_Wunused_variable = 888,                /* -Wunused-variable */
  OPT_Wuse_after_free = 889,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 890,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 891,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 892,                   /* -Wuseless-cast */
  OPT_Wvarargs = 893,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 894,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 895,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 896,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 897,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 898,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 899,            /* -Wvirtual-move-assign */
  OPT_Wvla = 900,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 901,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 902,                  /* -Wvla-parameter */
  OPT_Wvolatile = 903,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 904,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 905,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 906,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 907,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 908,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 909,                       /* -Wzerotrip */
  OPT_X = 910,                               /* -X */
  OPT_Xassembler = 911,                      /* -Xassembler */
  OPT_Xf = 912,                              /* -Xf */
  OPT_Xlinker = 913,                         /* -Xlinker */
  OPT_Xpreprocessor = 914,                   /* -Xpreprocessor */
  OPT_Z = 915,                               /* -Z */
  OPT_ansi = 916,                            /* -ansi */
  OPT_aux_info = 917,                        /* -aux-info */
  /* OPT_aux_info_ = 918, */                 /* -aux-info= */
  OPT_c = 919,                               /* -c */
  OPT_callgraph = 920,                       /* -callgraph */
  OPT_coverage = 921,                        /* -coverage */
  OPT_cpp = 922,                             /* -cpp */
  OPT_cpp_ = 923,                            /* -cpp= */
  OPT_d = 924,                               /* -d */
  OPT_debuglib_ = 925,                       /* -debuglib= */
  OPT_defaultlib_ = 926,                     /* -defaultlib= */
  OPT_defined_only = 927,                    /* -defined-only */
  OPT_demangle = 928,                        /* -demangle */
  OPT_dstartfiles = 929,                     /* -dstartfiles */
  OPT_dump_body_ = 930,                      /* -dump-body= */
  OPT_dump_level_ = 931,                     /* -dump-level= */
  OPT_dumpbase = 932,                        /* -dumpbase */
  OPT_dumpbase_ext = 933,                    /* -dumpbase-ext */
  OPT_dumpdir = 934,                         /* -dumpdir */
  OPT_dumpfullversion = 935,                 /* -dumpfullversion */
  OPT_dumpmachine = 936,                     /* -dumpmachine */
  OPT_dumpspecs = 937,                       /* -dumpspecs */
  OPT_dumpversion = 938,                     /* -dumpversion */
  OPT_e = 939,                               /* -e */
  OPT_export_dynamic = 940,                  /* -export-dynamic */
  OPT_fPIC = 941,                            /* -fPIC */
  OPT_fPIE = 942,                            /* -fPIE */
  OPT_fRTS_ = 943,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 944,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 945,                   /* -fabi-version= */
  OPT_faccess_control = 946,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 947,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 948,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 949,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 950,                  /* -falign-commons */
  OPT_falign_functions = 951,                /* -falign-functions */
  OPT_falign_functions_ = 952,               /* -falign-functions= */
  OPT_falign_jumps = 953,                    /* -falign-jumps */
  OPT_falign_jumps_ = 954,                   /* -falign-jumps= */
  OPT_falign_labels = 955,                   /* -falign-labels */
  OPT_falign_labels_ = 956,                  /* -falign-labels= */
  OPT_falign_loops = 957,                    /* -falign-loops */
  OPT_falign_loops_ = 958,                   /* -falign-loops= */
  /* OPT_faligned_new = 959, */              /* -faligned-new */
  OPT_faligned_new_ = 960,                   /* -faligned-new= */
  OPT_fall_instantiations = 961,             /* -fall-instantiations */
  OPT_fall_intrinsics = 962,                 /* -fall-intrinsics */
  OPT_fall_virtual = 963,                    /* -fall-virtual */
  OPT_fallocation_dce = 964,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 965,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 966,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 967,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 968, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 969,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 970,         /* -falt-external-templates */
  OPT_fanalyzer = 971,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 972,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 973,              /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 974,        /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 975,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 976,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 977,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 978,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 979,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 980,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 981,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 982,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 983,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 984,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 985, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 986,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 987, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 988, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 989, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 990, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 991,            /* -fasan-shadow-offset= */
  OPT_fasm = 992,                            /* -fasm */
  OPT_fassert = 993,                         /* -fassert */
  OPT_fassociative_math = 994,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 995,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 996,                   /* -fauto-inc-dec */
  OPT_fauto_init = 997,                      /* -fauto-init */
  OPT_fauto_profile = 998,                   /* -fauto-profile */
  OPT_fauto_profile_ = 999,                  /* -fauto-profile= */
  OPT_fautomatic = 1000,                     /* -fautomatic */
  OPT_fbackslash = 1001,                     /* -fbackslash */
  OPT_fbacktrace = 1002,                     /* -fbacktrace */
  OPT_fbit_tests = 1003,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1004,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1005,                        /* -fbounds */
  OPT_fbounds_check = 1006,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1007,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1008,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1009,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1010, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1011, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1012, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1013,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1014,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1015,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1016,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1017,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1018,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1019,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1020,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1021,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1022,                    /* -fcall-used- */
  OPT_fcaller_saves = 1023,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1024,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1025,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1026,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1027,      /* -fcanonical-system-headers */
  OPT_fcase = 1028,                          /* -fcase */
  /* OPT_fcf_protection = 1029, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1030,                /* -fcf-protection= */
  OPT_fchar8_t = 1031,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1032,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1033, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1034,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1035,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1036,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1037, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1038, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1039, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1040, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1041, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1042, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1043,                  /* -fcheckaction= */
  OPT_fchecking = 1044,                      /* -fchecking */
  OPT_fchecking_ = 1045,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1046,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1047,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1048,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1049,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1050,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1051,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1052,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1053,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1054,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1055,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1056,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1057,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1058,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1059,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1060,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1061,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1062,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1063,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1064, */                /* -fcilkplus */
  OPT_fcoarray_ = 1065,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1066,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1067,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1068,                        /* -fcommon */
  OPT_fcompare_debug = 1069,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1070,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1071,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1072,                  /* -fcompare-elim */
  OPT_fconcepts = 1073,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1074,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1075,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1076,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1077,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1078, */          /* -fconserve-space */
  OPT_fconserve_stack = 1079,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1080,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1081,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1082,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1083,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1084,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1085,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1086,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1087,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1088,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1089,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1090,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1091,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1092, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1093,                     /* -fcontracts */
  OPT_fconvert_ = 1094,                      /* -fconvert= */
  OPT_fcoroutines = 1095,                    /* -fcoroutines */
  OPT_fcpp = 1096,                           /* -fcpp */
  OPT_fcpp_begin = 1097,                     /* -fcpp-begin */
  OPT_fcpp_end = 1098,                       /* -fcpp-end */
  OPT_fcprop_registers = 1099,               /* -fcprop-registers */
  OPT_fcray_pointer = 1100,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1101,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1102,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1103, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1104,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1105,              /* -fcx-limited-range */
  OPT_fd = 1106,                             /* -fd */
  OPT_fd_lines_as_code = 1107,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1108,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1109,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1110,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1111,                      /* -fdbg-cnt= */
  OPT_fdce = 1112,                           /* -fdce */
  OPT_fdebug = 1113,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1114,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1115,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1116,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1117,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1118,             /* -fdebug-prefix-map= */
  ...
  OPT_fdiagnostics_all_candidates = 1149,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1150, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1151,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1152,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1153,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1154,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1155,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1156,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1157,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1158,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1159,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1160,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1161,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1162,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1163,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1164,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1165, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1166,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1167,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1168,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1169,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1170,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1171, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1172,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1173,               /* -fdirectives-only */
  OPT_fdisable_ = 1174,                      /* -fdisable- */
  OPT_fdoc = 1175,                           /* -fdoc */
  OPT_fdoc_dir_ = 1176,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1177,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1178,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1179,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1180,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1181,                      /* -fdruntime */
  OPT_fdse = 1182,                           /* -fdse */
  OPT_fdump_ = 1183,                         /* -fdump- */
  OPT_fdump_ada_spec = 1184,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1185,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1186,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1187,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1188,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1189,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1190,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1191,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1192,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1193,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1194,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1195,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1196,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1197,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1198,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1199,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1200,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1201,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1202, */               /* -fdump-core */
  OPT_fdump_d_original = 1203,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1204,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1205,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1206,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1207,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1208,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1209,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1210,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1211,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1212, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1213,                   /* -fdump-passes */
  OPT_fdump_scos = 1214,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1215,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1216,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1217,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1218,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1219,                /* -fearly-inlining */
  OPT_felide_constructors = 1220,            /* -felide-constructors */
  OPT_felide_type = 1221,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1222, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1223,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1224,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1225,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1226,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1227,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1228,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1229,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1230,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1231,                /* -fenum-int-equiv */
  OPT_fexceptions = 1232,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1233,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1234,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1235,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1236,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1237,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1238,               /* -fextended-opaque */
  OPT_fextern_std_ = 1239,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1240,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1241,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1242,            /* -fexternal-templates */
  OPT_ff2c = 1243,                           /* -ff2c */
  OPT_ffast_math = 1244,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1245,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1246,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1247,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1248,              /* -ffinite-math-only */
  OPT_ffixed_ = 1249,                        /* -ffixed- */
  OPT_ffixed_form = 1250,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1251,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1252,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1253,                   /* -ffloat-store */
  OPT_ffloatvalue = 1254,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1255,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1256,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1257,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1258, */              /* -fforce-addr */
  OPT_fforward_propagate = 1259,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1260,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1261,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1262,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1263,                     /* -ffpe-trap= */
  OPT_ffree_form = 1264,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1265,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1266,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1267,                  /* -ffreestanding */
  OPT_ffriend_injection = 1268,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1269,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1270,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1271,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1272,             /* -ffunction-sections */
  OPT_fgcse = 1273,                          /* -fgcse */
  OPT_fgcse_after_reload = 1274,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1275,                      /* -fgcse-las */
  OPT_fgcse_lm = 1276,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1277,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1278,              /* -fgen-module-list= */
  OPT_fgimple = 1279,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1280,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1281,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1282,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1283,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1284,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1285,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1286,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1287,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1288,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1289,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1290,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1291,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1292,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1293,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1294,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1295,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1296,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1297,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1298,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1299,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1300,                      /* -fgraphite */
  OPT_fgraphite_identity = 1301,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1302,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1303,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1304, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1305,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1306, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1307, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1308,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1309,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1310,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1311,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1312,                      /* -fhardened */
  /* OPT_fhelp = 1313, */                    /* -fhelp */
  /* OPT_fhelp_ = 1314, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1315,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1316,                     /* -fhonor-std */
  OPT_fhosted = 1317,                        /* -fhosted */
  OPT_fhuge_objects = 1318,                  /* -fhuge-objects */
  OPT_fident = 1319,                         /* -fident */
  OPT_fif_conversion = 1320,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1321,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1322,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1323,          /* -fimmediate-escalation */
  ...
  OPT_fm2_debug_trace_ = 1433,               /* -fm2-debug-trace= */
  OPT_fm2_g = 1434,                          /* -fm2-g */
  OPT_fm2_lower_case = 1435,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1436,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1437,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1438,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1439,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1440,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1441,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1442,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1443,             /* -fmacro-prefix-map= */
  OPT_fmain = 1444,                          /* -fmain */
  OPT_fmath_errno = 1445,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1446,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1447,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1448,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1449,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1450,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1451,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1452,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1453,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1454,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1455,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1456,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1457,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1458,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1459,                          /* -fmod= */
  OPT_fmodule_file_ = 1460,                  /* -fmodule-file= */
  OPT_fmodule_header = 1461,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1462,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1463,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1464,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1465,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1466,                   /* -fmodule-only */
  OPT_fmodule_private = 1467,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1468,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1469,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1470,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1471,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1472,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1473,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1474,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1475,                 /* -fms-extensions */
  OPT_fmudflap = 1476,                       /* -fmudflap */
  OPT_fmudflapir = 1477,                     /* -fmudflapir */
  OPT_fmudflapth = 1478,                     /* -fmudflapth */
  OPT_fmultiflags = 1479,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1480,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1481,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1482,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1483,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1484,                  /* -fnext-runtime */
  OPT_fnil = 1485,                           /* -fnil */
  OPT_fnil_receivers = 1486,                 /* -fnil-receivers */
  OPT_fno_inline_stringops = 1487,           /* -fno-inline-stringops */
  OPT_fno_modules = 1488,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1489,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1490,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1491,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1492,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1493,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1494,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1495,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1496,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1497,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1498,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1499,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1500,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1501,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1502,              /* -foffload-options= */
  OPT_foffload_ = 1503,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1504,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1505,                         /* -fonly= */
  OPT_fopenacc = 1506,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1507,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1508,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1509,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1510,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1511, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1512,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1513,                /* -foperator-names */
  OPT_fopt_info = 1514,                      /* -fopt-info */
  OPT_fopt_info_ = 1515,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1516, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1517,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1518,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1519, */          /* -foptional-diags */
  OPT_fpack_derived = 1520,                  /* -fpack-derived */
  OPT_fpack_struct = 1521,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1522,                  /* -fpack-struct= */
  OPT_fpad_source = 1523,                    /* -fpad-source */
  OPT_fpartial_inlining = 1524,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1525,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1526,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1527,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1528,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1529,                    /* -fpeel-loops */
  OPT_fpeephole = 1530,                      /* -fpeephole */
  OPT_fpeephole2 = 1531,                     /* -fpeephole2 */
  OPT_fpermissive = 1532,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1533,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1534,                           /* -fpic */
  OPT_fpie = 1535,                           /* -fpie */
  OPT_fpim = 1536,                           /* -fpim */
  OPT_fpim2 = 1537,                          /* -fpim2 */
  OPT_fpim3 = 1538,                          /* -fpim3 */
  OPT_fpim4 = 1539,                          /* -fpim4 */
  OPT_fplan9_extensions = 1540,              /* -fplan9-extensions */
  OPT_fplt = 1541,                           /* -fplt */
  OPT_fplugin_arg_ = 1542,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1543,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1544,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1545,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1546,                /* -fpostconditions */
  OPT_fpre_include_ = 1547,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1548,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1549,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1550,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1551,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1552,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1553,              /* -fpretty-templates */
  OPT_fpreview_all = 1554,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1555,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1556,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1557,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1558,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1559,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1560,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1561,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1562,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1563,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1564,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1565,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1566,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1567,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1568,           /* -fprintf-return-value */
  OPT_fprofile = 1569,                       /* -fprofile */
  OPT_fprofile_abs_path = 1570,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1571,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1572,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1573,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1574,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1575,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1576,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1577,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1578,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1579,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1580,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1581,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1582,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1583,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1584,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1585,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1586,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1587,               /* -fprofile-update= */
  OPT_fprofile_use = 1588,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1589,                  /* -fprofile-use= */
  OPT_fprofile_values = 1590,                /* -fprofile-values */
  OPT_fprotect_parens = 1591,                /* -fprotect-parens */
  OPT_fpthread = 1592,                       /* -fpthread */
  OPT_fq = 1593,                             /* -fq */
  ...
  OPT_list = 1955,                           /* -list */
  OPT_mabi_ = 1956,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1957,             /* -mabort-on-noreturn */
  OPT_mandroid = 1958,                       /* -mandroid */
  OPT_mapcs = 1959,                          /* -mapcs */
  OPT_mapcs_frame = 1960,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1961,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1962,              /* -mapcs-stack-check */
  OPT_march_ = 1963,                         /* -march= */
  OPT_marm = 1964,                           /* -marm */
  OPT_masm_syntax_unified = 1965,            /* -masm-syntax-unified */
  OPT_mbe32 = 1966,                          /* -mbe32 */
  OPT_mbe8 = 1967,                           /* -mbe8 */
  OPT_mbig_endian = 1968,                    /* -mbig-endian */
  OPT_mbionic = 1969,                        /* -mbionic */
  OPT_mbranch_cost_ = 1970,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 1971,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 1972,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1973,     /* -mcaller-super-interworking */
  OPT_mcmse = 1974,                          /* -mcmse */
  OPT_mcpu_ = 1975,                          /* -mcpu= */
